...
import '../helpers/translate_helpers.dart';
import '../localstorage/local_storage.dart';
import '../main.dart';
import '../models/task.dart';
import '../widgets/search_delegate.dart';
import '../widgets/tasklist_item.dart';
...
class _HomePageState extends State<HomePage> {
              ...
              itemBuilder: (context, index) {
                ...
                return Dismissible(
                  ...
                  onDismissed: (direction) {
                    ...
                    _localStorage.deletedTask(task: _oankiListeElemani);
                    setState(() {});
                  },
              ...
              onSubmitted: (value) {
                ...
                if (value.length > 3) {
                  DatePicker.showTimePicker(context,
                      locale: TranslateHelper.getDeviceLanguage(context),
  ...
  void _showSearchPage() async {
    await showSearch(
        context: context, delegate: CustomSearchDelegated(allTask: _allTasks));
    _getAllTaskFromDb();
  }
}
